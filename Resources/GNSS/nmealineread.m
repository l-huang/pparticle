...
%% James Pinchin    
    nline  =  nline(find(nline  ==  ',',1,'first') + 1:end);
    t_GPSFix  =  nline(1:find(nline  ==  ',',1,'first') - 1);
    data.GPSFix  =  str2double(t_GPSFix);
    nline  =  nline(find(nline  ==  ',',1,'first') + 1:end);
    t_nSats  =  nline(1:find(nline  ==  ',',1,'first') - 1);
    data.nSats  =  str2double(t_nSats);
    nline  =  nline(find(nline  ==  ',',1,'first') + 1:end);
    t_HDOP  =  nline(1:find(nline  ==  ',',1,'first') - 1);
